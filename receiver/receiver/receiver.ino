/*  
Credit: Electronoobs
edits for testing, direct functionality: B Nash
 */
...
{  
  ...
  // Set the PA Level low to prevent power supply related issues since this is a getting_started sketch, and the likelihood of close proximity of the devices. RF24_PA_MAX is default.
